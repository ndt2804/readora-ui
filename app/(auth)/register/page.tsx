                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-10 rounded-xl border-gray-200 focus:border-primary h-10"
                                required
                            />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            className="rounded-xl border-gray-200 focus:border-primary h-10"
                            required
                        />
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            onChange={handleInputChange}
                            className="pl-10 pr-10 rounded-xl border-gray-200 focus:border-primary h-10"
                            required
                        />
                        <button
                            type="button"
